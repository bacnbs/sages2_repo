...
if op_SAGES:
    if op_Local:
        ...
        dirNameOutput = r"C:\Users\mning\Documents\CNBS_Projects\SAGES I and II\Data\Baseline_rsEEG_preprocessing\FeatureStores"
    ...
    if op_Local:
        ...
        dirNameOutput = (
            r"C:\Users\mning\Documents\CNBS_Projects\Duke_Preop_EEG\DATA\FeatureStores"
        )
        dirFigOutput = r"C:\Users\mning\Documents\CNBS_Projects\Duke_Preop_EEG\DATA\DATA_visualization"
    else:
        dirNamePrep = r"R:\Studies_Investigator Folders\Shafi\2018P-000227_SAGES I and II\Duke Preop EEG Data\DATA\DATA_Preprocessed"
...
if testCase:
    ...
    if op_mV:
        if binWidth == 2 and bin2_startF:
            featStoreFN = rf"{dirNameOutput}\featureStore_Sbj_BP_{binWidth}Hz_{eo_str}_{relative_str}_car_{unit_str}.csv"
        else:
            featStoreFN = rf"{dirNameOutput}\featureStore_Sbj_BP_{binWidth}EvenHz_{eo_str}_{relative_str}_car_{unit_str}.csv"
    else:
        featStoreFN = rf"{dirNameOutput}\featureStore_Sbj_BP_{binWidth}Hz_{eo_str}_{relative_str}_car.csv"
...
if op_SAGES:
    ...
    # filter out recordings with custom montage manually
...
for i in range(1, endLoop):
    ...
    if binWidth == 2 and bin2_startF:
        ...
        freqBands.append([(i - 1) * binWidth, i * binWidth])
        band_names.append([str((i - 1) * binWidth) + "Hz"])
...
params["bin2_startF"] = bin2_startF
