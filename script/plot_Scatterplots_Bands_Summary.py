...
feat_SAGES_EO_FN = (
    ...
    rf"BP_Bands_EO_{relative_str}_car_mV.csv"
)

feat_SAGES_EC_FN = (
    rf"R:\Studies_Investigator Folders\Shafi\2018P-000227_SAGES I and II"
    rf"\Data\Baseline_rsEEG_preprocessing\FeatureStores\featureStore_Sbj_"
    rf"BP_Bands_EC_{relative_str}_car_mV.csv"
)

feat_DUKE_EO_FN = (
    rf"R:\Studies_Investigator Folders\Shafi\2018P-000227_SAGES I and II"
    rf"\Duke Preop EEG Data\DATA\FeatureStores\featureStore_Sbj_BP_Bands_"
...
id_Chn_alpha_EO = f"{ch_name}_{band_name}_EO"
id_Chn_alpha_EC = f"{ch_name}_{band_name}_EC"

ttst_SAGES_Untrnsfrm_EO = scipy.stats.ttest_ind(
    feats_DF_CAM_SAGES_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    feats_DF_Ctrl_SAGES_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    equal_var=False,
)
ttst_SAGES_Untrnsfrm_EC = scipy.stats.ttest_ind(
    feats_DF_CAM_SAGES_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    feats_DF_Ctrl_SAGES_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    equal_var=False,
)
ttst_DUKE_Untrnsfrm_EO = scipy.stats.ttest_ind(
    feats_DF_CAM_DUKE_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    feats_DF_Ctrl_DUKE_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    equal_var=False,
)
ttst_DUKE_Untrnsfrm_EC = scipy.stats.ttest_ind(
    feats_DF_CAM_DUKE_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    feats_DF_Ctrl_DUKE_Untrnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    equal_var=False,
)

ttst_SAGES_Trnsfrm_EO = scipy.stats.ttest_ind(
    feats_DF_CAM_SAGES_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    feats_DF_Ctrl_SAGES_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    equal_var=False,
)
ttst_SAGES_Trnsfrm_EC = scipy.stats.ttest_ind(
    feats_DF_CAM_SAGES_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    feats_DF_Ctrl_SAGES_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    equal_var=False,
)
ttst_DUKE_Trnsfrm_EO = scipy.stats.ttest_ind(
    feats_DF_CAM_DUKE_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    feats_DF_Ctrl_DUKE_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EO],
    equal_var=False,
)
ttst_DUKE_Trnsfrm_EC = scipy.stats.ttest_ind(
    feats_DF_CAM_DUKE_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    feats_DF_Ctrl_DUKE_Trnsfrm_Sbj.loc[:, id_Chn_alpha_EC],
    equal_var=False,
)
...
x_ticks_4zip = ["SAGES EO", "SAGES EC", "INTUIT/PRIME EO", "INTUIT/PRIME EC"]
...
x_ticks_lbls_Trnsfrm = [
    x_name + f" ({pval:.3f})" for (x_name, pval) in zip(x_ticks_4zip, pval_list_Trnsfrm)
]
...
axs[0].plot(
    -0.2,
    feats_DF_Ctrl_SAGES_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    0.2,
    feats_DF_CAM_SAGES_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    0.8,
    feats_DF_Ctrl_SAGES_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    1.2,
    feats_DF_CAM_SAGES_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    1.8,
    feats_DF_Ctrl_DUKE_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    2.2,
    feats_DF_CAM_DUKE_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    2.8,
    feats_DF_Ctrl_DUKE_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[0].plot(
    3.2,
    feats_DF_CAM_DUKE_Untrnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    -0.2,
    feats_DF_Ctrl_SAGES_Trnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    0.2,
    feats_DF_CAM_SAGES_Trnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    0.8,
    feats_DF_Ctrl_SAGES_Trnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    1.2,
    feats_DF_CAM_SAGES_Trnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    1.8,
    feats_DF_Ctrl_DUKE_Trnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    2.2,
    feats_DF_CAM_DUKE_Trnsfrm_Grp.loc[0, id_Chn_alpha_EO],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    2.8,
    feats_DF_Ctrl_DUKE_Trnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
axs[1].plot(
    3.2,
    feats_DF_CAM_DUKE_Trnsfrm_Grp.loc[0, id_Chn_alpha_EC],
    marker="s",
    markersize=10,
    color="k",
    linestyle="None",
...
# plt.ylim(0,2)
plt.tight_layout()
fig.suptitle(rf"{ch_name} {band_name} PSD Scatter Plots")
axs[1].legend([ctrl_hdl, del_hdl], ["Control", "Delirium"])
plt.savefig(os.path.join(fig_Dir_SAGES, f"ScatterPlot_{band_name}_BP_{ch_name}.png"))
